...
class MidasHistoryBinnedBuffer: public MidasHistoryBufferInterface
{
 public:
   int fNumBins = 0;
   time_t fFirstTime = 0;
 ...
 public: // following arrays are owned by the caller of hs_read_binned()
   int    *fCount = NULL;
   double *fMean  = NULL;
   double *fRms   = NULL;
   double *fMin   = NULL;
 ...
 public:
   MidasHistoryBinnedBuffer(time_t first_time, time_t last_time, int num_bins); // ctor
